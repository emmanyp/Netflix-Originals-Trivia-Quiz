...
function getRandomLcdpQuestions() {
  return laCasaDePapleQuestions[Math.floor(Math.random() * (laCasaDePapleQuestions.length - 1))]
}


export {
	getRandomLcdpQuestions
}